...
import com.sunsunsoft.shutaro.ugui.ViewTouchCallbacks;
...
public class TestTouchView extends View implements View.OnTouchListener, UButtonCallbacks, ViewTouchCallbacks {
    ...
    private void initDrawables(int width, int height) {
        ...
        // LogWindow
        logWindows[0] = ULogWindow.createInstance(getContext(), this, ULogWindow.LogWindowType.Fix,
                0, 0,
                width / 2, height);
        logWindows[1] = ULogWindow.createInstance(getContext(), this, ULogWindow.LogWindowType.Fix,
                width / 2, 0,
                width / 2, height);
