...
abstract public class DrawableClass implements Drawable{
    private static final String TAG = "DrawableClass";
    ...
    public DrawableClass(float x, float y, int width, int height)
    {
        this.setPos(x, y);
