...
import com.sunsunsoft.shutaro.ugui.uview.button.UButtonImage;
import com.sunsunsoft.shutaro.ugui.uview.button.UButtonText;
...
public class UDialogWindow extends UWindow implements UButtonCallbacks {
    ...
    {
        super(null, UDrawManager.DrawPriority.Dialog.p(), x, y, screenW, screenH, dialogColor);
